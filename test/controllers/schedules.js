...
describe('/GET schedules for a invalid day in a valid week', () => {
    var token;
    before(function (done) {
        chai.request(api)
            .post('/login')
    ...
    it('it should return 400 with no schedules', (done) => {
        chai.request(api)
...
describe('/GET schedules for a invalid day in a invalid week', () => {
    var token;
    before(function (done) {
        chai.request(api)
            .post('/login')
...
describe('/GET schedules for tuesday in a week', () => {
    ...
    it('it should return 200 with the schedule for tuesday we have defined in the previous test', (done) => {
        chai.request(api)
...
describe('/GET schedules for friday in a week', () => {
    ...
    it('it should return 200 with the schedule for friday we have defined in the previous test', (done) => {
        chai.request(api)
